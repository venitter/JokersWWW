    ...
    <div class="item">
      ...
      <div>
        <template v-for="signup in signups">
          <div :key="signup.id" v-if="signup.grp == 0" @dragover.prevent @drop="onDropParty">
            <div draggable="true" @drag="onDrag">
              <div hidden>0</div>
...
export default {
  ...
  methods: {
    ...
    onDropParty: function(e) {
      ...
      axios.post("http://35.156.131.239:3000/updateGroup", data);

      this.signups[src_id].grp = tgt_grp;
      if (tgt_id > -1) {
        this.signups[tgt_id].grp = src_grp;
      }
    },
    ...
    onDropPA: function(e) {
      ...
      // axios request tu bydzie
      axios.post("http://35.156.131.239:3000/updatePA", data);

      this.signups[src_id].pa = tgt_pa;
      if (tgt_id > -1) {
        this.signups[tgt_id].pa = src_pa;
      }
    },
