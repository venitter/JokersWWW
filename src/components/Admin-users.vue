<template>
  <div class="cont">
    <div class="butt">
      <div class="button" @click="aktywni">Jokers</div>
      <div class="button" @click="nieaktywni">Goście</div>
      <div class="button" @click="wszyscy">Wszyscy</div>
    </div>
    <div>
      <table>
        <thead>
        ...
        <tbody>
          ...
          <tr
            v-show="nieakt"
            v-bind:key="user.idusers"
            v-for="user in usersKicked"
...
export default {
  ...
  computed: {
    ...
    usersKicked: function() {
      var wynik = this.users.filter(e => {
        return e.active == 0 || e.active == null;
      });
      return wynik;
    }
  },
